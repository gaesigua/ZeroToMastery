...
public class FixedThreadPoolExample {
    public static void main(String[] args) {
        //Here we are creating a thread pool with 2 threads
        ...
        executor.shutdown();  //similar to before, this will make the executor accept no new tasks and shut down after all runn
    }
}
