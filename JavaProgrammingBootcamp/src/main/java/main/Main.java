...
public class Main{
    public static void main(String[] args) {
        ...
        //1. EXERCISE 1: BASIC BANK ACCOUNT
        //Let's create an instance for the first exercise and Set some values
        ...
        //Let's create instances for the second exercise
        ...
        //Let's set some values for the "Inventory" class
        ...
        //3. EXERCISE 3: UNIVERSITY APPLICATION
        //Let's create instances/objects for the 3 classes in the inventory

        Student student = new Student();
        Course course = new Course();
        Enrollment enrollment = new Enrollment();

        //Let's set some values for the "Student" class
        student.studentId = 12;
        student.name = "gaesigua tin";

        //Let's set some values for the "Course" class
        course.courseId = 33;
        course.courseName = "Software Engineering";

        //Let's set some values for the "Enrollment" class
        ...
        //Let's print out all the values of the fields for the third exercise

        System.out.println("The Student ID: " + enrollment.student.studentId + ", NAME: " + enrollment.student.name );
        System.out.println("The Course ID: " + course.courseId + ", NAME: " + course.courseName);
